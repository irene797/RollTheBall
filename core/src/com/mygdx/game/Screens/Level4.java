...
public class Level4 extends BaseScreen {
    ...
    public void show() {
        ...
        platform1 = new Platform(8, 7.5f, new Texture("bushes/bushFor4.png"), 10, 3);
        platform2 = new Platform(8, 1.5f, new Texture("bushes/bushFor4.png"), 10, 3);

        ball = new Ball(1, 4.5f, 0.5f, 1);
